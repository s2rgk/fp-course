...
convertInteractive = putStrLn "Enter the string. I will convert it to UPPER CASE. Come on:" >-
...
reverseInteractive = putStrLn "Enter the file to reverse:" >-
                     getLine >>= \source ->
                     putStrLn "Ok. Now enter the file to write the reversed file:" >-
                     getLine >>= \target ->
...
encodeInteractive = putStrLn "Enter a string to url encoding:" >-
                    getLine >>= putStrLn . flatMap encodeUrl
...
interactive =
  ...
  in vooid (untilM (\c -> if c == 'q'
             ...
             (putStrLn "Select: " >-
              traverse (\(Op c s _) -> putStr (c :. Nil) >-
                                       putStr ". " >-
                                       putStrLn s) ops >-
              getChar >>= \c ->
              putStrLn "" >-
